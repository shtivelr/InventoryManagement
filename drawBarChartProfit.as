...
import flash.events.MouseEvent;
	...
	public class drawBarChartProfit extends MovieClip{
		public var TextArray:Array = new Array();
		
		public function drawBarChartProfit(recX:Number, recY:Number, recWidth:Number, recHeight:Number, recScaleY:int){
...
myTextField.text = "Forecasted Profit"; 
